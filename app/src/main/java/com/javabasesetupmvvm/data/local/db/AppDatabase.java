...
import com.javabasesetupmvvm.data.local.db.dao.OptionDao;
import com.javabasesetupmvvm.data.local.db.dao.QuestionDao;
import com.javabasesetupmvvm.data.local.db.dao.UserDao;
