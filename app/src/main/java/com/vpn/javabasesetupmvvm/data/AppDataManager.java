...
import com.vpn.javabasesetupmvvm.utils.CommonUtils;
...
public class AppDataManager implements DataManager {
    ...
    public Single<JsonObject> getInstagramAccessTokenApiCall(Map<String, String> requestParams) {
        return mApiHelper.getInstagramAccessTokenApiCall(requestParams);
    }

    @Override
    public Single<JsonObject> doInstagramLoginApiCall() {
        return mApiHelper.doInstagramLoginApiCall();
    }
